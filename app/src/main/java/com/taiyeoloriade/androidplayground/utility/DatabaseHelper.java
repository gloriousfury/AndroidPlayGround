package com.taiyeoloriade.androidplayground.utility;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public long createToDo(Todo todo, long[] tag_ids) {
        ...
        values.put(KEY_DEADLINE, todo.getDeadline());
        // insert row
    ...
    public Todo getTodo(long todo_id) {
        ...
        td.setDeadline(c.getLong(c.getColumnIndex(KEY_DEADLINE)));
