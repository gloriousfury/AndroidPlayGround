...
import com.taiyeoloriade.androidplayground.model.ViewPagerItemModel;
...
public class CustomPagerAdapter extends PagerAdapter {
    ...
    public CustomPagerAdapter(Context context, String[] title, String[] description, int[] icons ) {
